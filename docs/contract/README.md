...
| ANNY Basic v1.2 model | active | `internal/strategy/annybasic`, `internal/indicators`, `internal/backtest` | `docs/strategy/anny-basic-v1.2.md`, `docs/strategy/success-model-anny-basic.md` | Complete fee-adjusted paper/walk-forward validation; connect decisions to mission confirmation and Flight Recorder on testnet. | Strategy/backtest tests; legal wording review. |
